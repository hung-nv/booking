...
var Page = /** @class */ (function () {
     ...
     * Set from validate.
     */
    Page.prototype.checkFormValidate = function () {
     ...
     * Set ajax csrf.
     */
    Page.prototype.setAjaxCsrf = function () {
        $.ajaxSetup({
            headers: { 'X-CSRF-TOKEN': $(ui.metaCsrfToken).attr('content') }
        });
    };
    Page.prototype.confirmBeforeDelete = function (even) {
...
exports.confirmBeforeDelete = confirmBeforeDelete;
/**
 * Get param in url
 * @param name
 * @returns {string} | null
 ...
 * @param option
 */
function doException(xhr, option) {
    ...
    if (xhr.status === 402) {
        ...
        var messages = typeof xhr.responseJSON === 'string' ? [xhr.responseJSON] : xhr.responseJSON;
...
exports.doException = doException;
/**
...
// Get list components.
var dispatcher_1 = __webpack_require__(94);
var PageModuleParser_1 = __webpack_require__(95);
// List components
var pageModulers = {};
for (var pageId in dispatcher_1.default) {
    var path = dispatcher_1.default[pageId];
    pageModulers[pageId] = __webpack_require__(352)("./" + path).default;
}
// Each page has only a main component.
// Main component has class is mainComponent.
var moduleElement = $('.mainComponent');
if (moduleElement) {
    // Id of element main component is key to find vue com.
    var pageId = moduleElement.attr('id');
    if (pageId && (typeof pageModulers[pageId] !== undefined)) {
        var pageModule = new pageModulers[pageId];
        PageModuleParser_1.applyBoot(pageModule);
        var mainComponent = PageModuleParser_1.createMainVue(pageModule, "#" + pageId);
        window.mainComponent = mainComponent;
        // Register custom events.
        PageModuleParser_1.registerEvent(pageModule, mainComponent);
        // Run setUp(on ready function)
        PageModuleParser_1.applySetUp(pageModule, mainComponent);
    }
}
...
Object.defineProperty(exports, "__esModule", { value: true });
// Import vendor.
var vue_1 = __webpack_require__(348);
var defaultOptions = [
    'setUp',
    'events',
    'data',
...
function registerEvent(pageModule, mainComponent) {
    // Events.
    if (typeof pageModule.events !== 'undefined') {
        var _loop_1 = function (eventString) {
            var event_1 = pageModule.events[eventString];
            var _a = eventString.split(' '), eventName = _a[0], eventTargetString = _a[1];
            var eventTargets = eventTargetString.split('::');
            ...
            if (eventTargets.length > 1) {
                ...
                $(function () { return $(eventTargetParent).on(eventName, eventTarget, event_1.bind(mainComponent)); });
            }
            else {
                eventTarget = eventTargets[0];
                $(function () { return $(eventTarget).on(eventName, event_1.bind(mainComponent)); });
            }
        };
        for (var eventString in pageModule.events) {
            _loop_1(eventString);
        }
    }
}
exports.registerEvent = registerEvent;
function applySetUp(pageModule, mainComponent) {
    if (typeof pageModule.setUp !== 'undefined') {
        // Run setup.
        $(function () { pageModule.setUp.call(mainComponent); });
    }
}
exports.applySetUp = applySetUp;
function applyBoot(pageModule) {
...
exports.applyBoot = applyBoot;
/**
 * Create main vue.
 * @param pageModule
 * @param el
 */
function createMainVue(pageModule, el) {
    var vueOption = getVueOption(pageModule, el);
    return new vue_1.default(vueOption);
}
exports.createMainVue = createMainVue;
/**
 * Convert pageModule to vue options.
 * @param pageModule
 * @param el
 */
function getVueOption(pageModule, el) {
    var vueOptions = {};
    vueOptions.el = el;
    ...
    for (var propertyName in pageModule) {
        var property = pageModule[propertyName];
    ...
    if (typeof vueOptions.data === 'function') {
        var dataFunc_1 = vueOptions.data;
        vueOptions.data = function () {
            return Object.assign(dataFunc_1(), vueData);
        };
    }
    else {
...
function default_1() {
     ...
     */
    $.validator.addMethod('special_character', function (value) {
        return !/\%|\_|\\|\//.test(value);
    });
    /**
     *  Validate require number int [0, data-max]
     */
    $.validator.addMethod('unique_in', function (value, element, params) {
        var valid = true;
        var $element = $(element);
     ...
     */
    $.validator.addMethod('range_result', function (value, element, params) {
        var valid = true;
        var attribute = $(element).data('attribute').split('.');
        var rowFind = _.find(params.data, { 'id': Number(attribute[1]) });
        if (value != '' && rowFind.lower != '' && rowFind.upper != '') {
            var lower = Number(rowFind.lower.replace(/,/g, ''));
            var upper = Number(rowFind.upper.replace(/,/g, ''));
     ...
     */
    $.validator.addMethod('smaller_than', function (value, element, params) {
        var paramValue = $("[name=" + params + "]").val();
        if (paramValue !== '') {
            var maxValue = parseFloat(paramValue.replace(/,/g, ''));
            var thisValue = parseFloat(value.replace(/,/g, ''));
     ...
     */
    $.validator.addMethod('between', function (value, element, params) {
        var start = parseFloat($('.m-between-parent-start').val().replace(/,/g, ''));
        var end = parseFloat($('.m-between-parent-end').val().replace(/,/g, ''));
        var thisValue = parseFloat(value.replace(/,/g, ''));
     ...
     */
    $.validator.addMethod('range_of_weekly', function (value, element, params) {
        var weekly_start = moment(value);
        var weekly_end = moment($("[name=" + params[1] + "]").val());
     ...
     */
    $.validator.addMethod('range_of_monthly', function (value, element, params) {
        var weekly_start = moment(value);
        var weekly_end = moment($("[name=" + params[1] + "]").val());
        if (Math.abs(weekly_end.diff(weekly_start, 'days')) < params[0]) {
            return false;
...
var el;
// Get cofig button OK.
var getButtonOk = function (option) {
    return {
...
var getButtonCancel = function (option) {
    return {
...
var getButtons = function (option) {
    var buttons = [];
    for (var index in option.buttons) {
        var buttonOption = option.buttons[index];
        var button = {
...
dialog.open = function (option) {
    ...
    var html = compiled({ 'className': option.className, 'message': option.message, 'buttons': buttons });
...
dialog.close = function () { el.modal('hide'); };
...
Object.defineProperty(exports, "__esModule", { value: true });
var page_1 = __webpack_require__(14);
var ui = {
...
var Attribute = /** @class */ (function (_super) {
    ...
    Attribute.prototype.setDatatable = function () {
...
var Branch = /** @class */ (function (_super) {
    ...
    Branch.prototype.setDatatable = function () {
        if ($(ui.tablePages).length) {
            $(ui.tablePages).dataTable({
                ordering: false,
                order: [[0, 'desc']],
...
var Category = /** @class */ (function (_super) {
    ...
    function Category() {
        ...
        _this.categoryName = viewData.oldName;
        _this.categorySlug = viewData.oldSlug;
        /**
        ...
        _this.watch = {
            categoryName: function (newValue, oldValue) {
                this.categorySlug = helpers_1.slugify(newValue);
            }
        };
        return _this;
    }
     ...
     */
    Category.prototype.setInputImage = function () {
        if ($(ui.inputImage).length) {
            if ($(ui.inputOldImage).length) {
                image_1.initInputImage(ui.inputOldImage, ui.inputImage, ui.urlDeleteImage);
            }
            else {
...
var Comment = /** @class */ (function (_super) {
     ...
     * Set focus to first input if create category.
     */
    Comment.prototype.setFocus = function () {
        if ($(ui.inputImage).length) {
            $('#comment-name').focus();
        }
    };
     ...
     * Datatable for category.
     */
    Comment.prototype.setDatatable = function () {
        if ($(ui.tableCategory).length) {
            $(ui.tableCategory).dataTable({
                ordering: false,
                order: [[0, 'desc']],
     ...
     * Set input image preview.
     */
    Comment.prototype.setInputImage = function () {
        if ($(ui.inputImage).length) {
            if ($(ui.inputOldImage).length) {
                image_1.initInputImage(ui.inputOldImage, ui.inputImage, ui.urlDeleteImage);
            }
...
var Landing = /** @class */ (function (_super) {
    ...
    function Landing() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.postName = viewData.oldName;
        _this.postSlug = viewData.oldSlug;
        /**
         * An object where keys are expressions to watch and values are the corresponding callbacks.
        ...
        _this.watch = {
            postName: function (newValue, oldValue) {
                this.postSlug = helpers_1.slugify(newValue);
            }
        };
        return _this;
    }
    Landing.prototype.setUp = function () {
        this.setDatatable();
        this.setInputImage();
    };
    Landing.prototype.setDatatable = function () {
        if ($(ui.tablePages).length) {
            $(ui.tablePages).dataTable({
                ordering: false,
                order: [[0, 'desc']],
...
var Menu = /** @class */ (function (_super) {
    ...
    Menu.prototype.setUp = function () {
        if (helpers_1.getParameterByName('menu_group') != null) {
            this.idMenuGroup = Number(helpers_1.getParameterByName('menu_group'));
        }
        // sort menu.
        this.nestableSort();
    };
     ...
     * @param event
     */
    Menu.prototype.selectMenuGroup = function (event) {
     ...
     * @param event
     */
    Menu.prototype.createMenu = function (event) {
        if (this.nameMenu === '') {
            return;
        }
        $.ajax({
            ...
            helpers_1.doException(xhr, { elementShowError: '.show-error' });
        });
    };
    /**
     * Sort menu.
     */
    Menu.prototype.nestableSort = function () {
        var _this = this;
        $(ui.divNestable).nestable({
            ...
            $.ajax({
                ...
                data: { data: $(ui.divNestable).nestable("serialize"), menu_group: _this.idMenuGroup }
            }).done(function (respon) {
            }).fail(function (xhr) {
     ...
     * @param event
     */
    Menu.prototype.addCategoryToMenu = function (event) {
        var _this = this;
        var idsCategory;
        if (!this.idMenuGroup) {
     ...
     * Add page o menu.
     */
    Menu.prototype.addPageToMenu = function () {
        var _this = this;
        var idsPages;
        if (!this.idMenuGroup) {
            this.beforeExecuteMenu();
     ...
     * Add custom to menu.
     */
    Menu.prototype.addCustomToMenu = function () {
        var _this = this;
        if (!this.idMenuGroup) {
            this.beforeExecuteMenu();
            return;
     ...
     * @param idMenu
     */
    Menu.prototype.deleteMenu = function (idMenu) {
        var _this = this;
        swal({
            title: 'Are you sure?',
            type: 'warning',
    ...
    Menu.prototype.beforeExecuteMenu = function () {
...
var Post = /** @class */ (function (_super) {
    ...
    Post.prototype.setDatatable = function () {
        if ($(ui.tablePages).length) {
            $(ui.tablePages).dataTable({
                ordering: false,
                order: [[0, 'desc']],
     ...
     * Set input image preview.
     */
    Post.prototype.setInputImage = function () {
        if ($(ui.inputImage).length) {
            if ($(ui.inputOldImage).length) {
                image_1.initInputImage(ui.inputOldImage, ui.inputImage, ui.urlDeleteImage);
            }
...
var Post = /** @class */ (function (_super) {
    ...
    Post.prototype.setInputImage = function () {
        if ($(ui.inputImage).length) {
            if ($(ui.inputOldImage).length) {
                ...
                image_1.newInputImage(ui.inputImage);
            }
        }
        $(ui.inputImage).on('fileclear', function (event) {
            $(ui.inputRemoveInitPreview).trigger("click");
    ...
    Post.prototype.addGroup = function (element) {
        var _this = this;
    ...
    Post.prototype.removeGroup = function (element) {
        var _this = this;
        var groupId, groupName, postId;
        groupId = $(element).data('group-id');
        groupName = $(element).data('group-name');
        ...
        $.ajax({
            ...
            _this.createContainerSet($(element));
        }).fail(function (xhr) {
            helpers_1.doException(xhr);
        });
    };
    Post.prototype.createContainerChecked = function (container) {
    ...
    Post.prototype.createContainerSet = function (container) {
...
var Product = /** @class */ (function (_super) {
    ...
    function Product() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.masterAttributeName = '';
        _this.masterAttributeId = 0;
        _this.attributeName = '';
        _this.productName = viewData.oldName;
        _this.productSlug = viewData.oldSlug;
        _this.showProductImages = false;
        /**
         * An object where keys are expressions to watch and values are the corresponding callbacks.
         * @type {{postName: (newValue, oldValue) => void}}
         */
        _this.watch = {
            productName: function (newValue, oldValue) {
                this.productSlug = helpers_1.slugify(newValue);
            }
        };
        return _this;
    }
    ...
    Product.prototype.openPopupEvent = function (event) {
     ...
     */
    Product.prototype.changeCoverImage = function (event) {
        var wrapImages = $(event.target).parents('.td-product-img').find('.product-image-thumb');
     ...
     * @param event
     */
    Product.prototype.updateCoverImage = function (event) {
        var self = $(event.target);
        var coverImg = self.data('img'), productId = self.data('id'), srcImg = self.attr('src');
        ...
        $.ajax({
            ...
            toastr.info(respon.message);
            var currentImg = self.parents('.td-product-img').find('.backend-img').children();
            var wrapImages = self.parents('.td-product-img').find('.product-image-thumb');
            wrapImages.hide();
     ...
     */
    Product.prototype.setInitImage = function () {
        if ($(ui.inputOldImage).length) {
            // update product.
            image_1.initInputMultiImage(ui.inputOldImage, ui.inputImage, ui.urlDeleteImage);
        }
        else {
            if ($(ui.inputImage).length) {
                // create product.
                image_1.newInputMultiImage(ui.inputImage);
            }
        }
    };
    /**
     ...
     * @param even
     */
    Product.prototype.openPopupAttribute = function (even) {
     ...
     * Add attribute.
     */
    Product.prototype.addAttribute = function () {
        var _this = this;
        ...
        $.ajax({
            ...
            $(ui.blockUpdateAttribute + _this.masterAttributeName).load(ui.urlUpdateBladeAttribute + _this.masterAttributeId);
            // empty attribute name.
            _this.attributeName = '';
        }).fail(function (xhr) {
            helpers_1.doException(xhr, { elementShowError: '.alert-error' });
        });
        setTimeout(function () {
            $('.alert-danger').remove();
        }, 3000);
     ...
     * @param event
     */
    Product.prototype.enterAddAttribute = function (event) {
        if (event.keyCode === 13) {
            this.addAttribute();
        }
        // preven submit form.
...
var Setting = /** @class */ (function (_super) {
     ...
     * Set input image preview.
     */
    Setting.prototype.setInputImage = function () {
        // init favico.
...
var User = /** @class */ (function (_super) {
    ...
    User.prototype.setDatatable = function () {
        if ($(ui.tablePages).length) {
            $(ui.tablePages).dataTable({
                ordering: false,
                order: [[0, 'desc']],
...
dialog_1.default.open({ message: 'message content' });
 ...
 */
function number_format(number, digit, dec_point) {
    ...
    var numFloat = parseFloat(number), numInt = parseInt(number);
    ...
    var _val_arr = digit > 0 ?
        parseFloat(number).toFixed(digit).split('.') : parseInt(number).toString().split('.'), result = '', _before = _val_arr[0], _negative = _before[0] === '-' ? '-' : '', _count = _before.length, new_number = '', first = true, i = _negative === '-' ? 1 : 0;
    for (i; i < _count; i++) {
...
exports.is_number_format = is_number_format;
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(11)(proto, TO_PRIMITIVE, __webpack_require__(234));
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(96), __webpack_require__(349).setImmediate))
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(96), __webpack_require__(351)))
...
var map = {
	...
	"./dispatcher.ts": 94,
	"./pages/Attribute": 133,
	"./pages/Attribute.ts": 133,
	"./pages/Branch": 134,
	"./pages/Branch.ts": 134,
	"./pages/Category": 135,
	"./pages/Category.ts": 135,
	"./pages/Comment": 136,
	"./pages/Comment.ts": 136,
	"./pages/Landing": 137,
	"./pages/Landing.ts": 137,
	"./pages/Menu": 138,
	"./pages/Menu.ts": 138,
	"./pages/Page": 139,
	"./pages/Page.ts": 139,
	...
	"./pages/Post.ts": 140,
	"./pages/Product": 141,
	"./pages/Product.ts": 141,
	"./pages/Setting": 142,
	"./pages/Setting.ts": 142,
	"./pages/User": 143,
	"./pages/User.ts": 143,
	"./systems/PageModule": 144,
	"./systems/PageModule.ts": 144,
	"./systems/PageModuleParser": 95,
	"./systems/PageModuleParser.ts": 95,
	"./systems/page": 14,
	"./systems/page.ts": 14,
	"./utilities/common/helpers": 30,
	"./utilities/common/helpers.ts": 30,
	"./utilities/dialog/DialogOptionInterface": 145,
	"./utilities/dialog/DialogOptionInterface.ts": 145,
	"./utilities/dialog/dialog": 98,
	"./utilities/dialog/dialog.ts": 98,
	"./utilities/dialog/example": 146,
	"./utilities/dialog/example.ts": 146,
	"./utilities/form_watcher/form_watcher": 147,
	"./utilities/form_watcher/form_watcher.ts": 147,
	"./utilities/formater/formater": 148,
	"./utilities/formater/formater.ts": 148,
	"./utilities/image/image": 31,
	"./utilities/image/image.ts": 31,
	"./utilities/mixins/mixins": 149,
	"./utilities/mixins/mixins.ts": 149,
	"./utilities/validate_rule/rules": 97,
	"./utilities/validate_rule/rules.ts": 97
};
