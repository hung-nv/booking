...
<head>
    ...
    <link href="{{ asset('/admin/assets/global/plugins/font-awesome/css/font-awesome.min.css') }}" rel="stylesheet"
          type="text/css"/>
    <link href="{{ asset('/admin/assets/global/plugins/simple-line-icons/simple-line-icons.min.css') }}"
    ...
    <link href="{{ asset('/admin/assets/css/components.min.css') }}" rel="stylesheet" id="style_components"
          type="text/css"/>
    <link href="{{ asset('/admin/assets/css/plugins.min.css') }}" rel="stylesheet" type="text/css"/>
    <!-- END THEME GLOBAL STYLES -->
    <!-- BEGIN PAGE LEVEL STYLES -->
    <link href="{{ asset('/admin/assets/css/login-5.min.css') }}" rel="stylesheet" type="text/css"/>
    ...
    <div class="row bs-reset">
        <div class="col-md-6 bs-reset">
            <div class="login-bg" style="background-image:url('{{ asset('/admin/assets/pages/img/login/bg1.jpg') }}')">
                <img class="login-logo" src="{{ asset('/admin/assets/pages/img/login/logo.png') }}"/></div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <input class="form-control form-control-solid placeholder-no-fix form-group" type="email"
                                   ...
                                   value="{{ old('email') }}" required autofocus/></div>
                        <div class="col-xs-6">
...
<!-- END CORE PLUGINS -->
<!-- BEGIN PAGE LEVEL PLUGINS -->
<script src="{{ asset('/admin/assets/global/plugins/jquery-validation/js/jquery.validate.min.js') }}"
        type="text/javascript"></script>
<script src="{{ asset('/admin/assets/global/plugins/jquery-validation/js/additional-methods.min.js') }}"
        type="text/javascript"></script>
<script src="{{ asset('/admin/assets/global/plugins/select2/js/select2.full.min.js') }}"
        type="text/javascript"></script>
<script src="{{ asset('/admin/assets/global/plugins/backstretch/jquery.backstretch.min.js') }}"
        {{--type="text/javascript"></script>--}}
<!-- END PAGE LEVEL PLUGINS -->
